...
class ShogiBanTest {
    ...
    class MoveTest {
        ...
        void testMoveToEmptyMasu() {
            ...
            var to = new Masu(1, 2);
            var koma = new Koma(StandardKomaType.歩兵, MovingDirection.LOWER);
        ...
        void testMoveAndPickExistingKoma() {
            ...
            var to = new Masu(7, 4);
            var moveKoma = new Koma(StandardKomaType.歩兵, MovingDirection.LOWER);
            ban.setKoma(moveKoma, from);
            var placedKoma = new Koma(StandardKomaType.歩兵, MovingDirection.LOWER);
            ban.setKoma(placedKoma, to);
            var otherKoma = new Koma(StandardKomaType.歩兵, MovingDirection.LOWER);
